                    ...
                    <div class="card-body card-full">
                        <table class="table table-bordered table-condensed table-responsive" id="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><a class="btnInfo" href="#"><img class="rounded"
                                  src="{{ asset($obj->img_path)}}"
                                  width="80"></a></td>
                                  <td><a class="btnInfo" href="preview_user.php?id=2">{{ $obj->name }}</a></td>
                                  <td>{{ $obj->email }}</td>
                                  <td>{{ $obj->created_at->format('j F, Y \\a\\t h:i A') }}</td>
                                </tr>
                                @endforeach
                                <tr>
                                    <td><a class="btnInfo" href="preview_user.php?id=1"><img
                                                src="https://localhost/votters/avatars/2021/5/t_khurshidkhan9_1_1620559109.jpg"
                                                width="80"></a></td>
                                    <td><a class="btnInfo" href="preview_user.php?id=1">Khurshidkhan9</a></td>
                                    <td>Khurshidkhan@gmail.com</td>
                                    <td>May 9, 2021</td>
                                </tr>
                            </tbody>
                        </table>
